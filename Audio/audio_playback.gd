...
signal stream_request_np_playback(
    stream: AudioStream,
    volume: float,
...
signal item_request_np_playback(
    id: StringName,
    volume: float,
    max_pitch_variance: float,
    bus: StringName
...
signal stream_request_2d_playback(
    stream: AudioStream,
    position: Vector2,
    volume: float,
    max_pitch_variance: float,
...
signal item_request_2d_playback(
    id: StringName,
    position: Vector2,
    volume: float,
    max_pitch_variance: float,
...
signal stream_request_3d_playback(
    stream: AudioStream,
    position: Vector3,
    volume: float,
    max_pitch_variance: float,
...
signal item_request_3d_playback(
    id: StringName,
    position: Vector3,
    volume: float,
    max_pitch_variance: float,
...
func play_stream(stream: AudioSample,
    ...
    stream_request_np_playback.emit(
        stream,
        volume,
        max_pitch_variance,
        bus
...
func play_stream_2d(stream: AudioSample,
    ...
    stream_request_2d_playback.emit(
        stream,
        position,
        volume,
        max_pitch_variance,
...
func play_stream_3d(stream: AudioSample,
    ...
    stream_request_3d_playback.emit(
        stream,
        position,
        volume,
        max_pitch_variance,
